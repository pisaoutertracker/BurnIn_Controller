...
def generate() -> str:
    ...
    lines.append("# This file is automatically generated. Do not edit manually.")
    lines.append("# To recreate or modify this sequence, run:")
    lines.append("# python3 generate_standard_burnin_v6.py")
